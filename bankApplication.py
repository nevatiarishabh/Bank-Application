...
# -*- coding: utf-8 -*-
"""
Created on Wed May 20 23:51:56 2020
...
try : 
    ...
    db = sql.connect('bank.db')
    c = db.cursor()
    c.execute('create table user(name varchar(50) not null primary key,password varchar(30) not null, balance double not null)')
    c.execute('insert into user values("rishabh","nevatiarishabh",500000)')
    c.execute('insert into user(name,password,balance) values("riddham","gadiariddham",70000), ("smit","chatwanismit",60000)')
    db.commit()
    c.close()
    db.close()
...
class Bank:
    ...
    def show_profile(self):
        ...
        self.p_l1 = Label(self.profframe,text='Account Details ' ,bg="gray",font=('Times','18','bold'),fg="#ffffff")
        ...
        self.p_l4 = Label(self.profframe,text='Account No:{}'.format("AC00"+str(random.randint(1000,9999))+str(random.randint(1000,9999))),bg="gray",font=('Times','18','bold'),fg="#ffffff")
        self.p_l4.grid(row=3,column=0,columnspan=2,padx=64)
